...
class _ProductDetailPageState extends State<ProductDetailPage>
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: TabBarView(
              ...
              children: <Widget>[
                Text(
                  "With over 2,300 pieces, this impressive reproduction features a removable canopy.",
                  style: TextStyle(
                    color: Colors.black,
                  ),
                ),
                Text(
                  "Includes a mounting bracket, 3 minifigures and a nameplate.",
                  style: TextStyle(
                    color: Colors.black,
                  ),
                )
  ...
  _buildMoreInfoData() {
    return Padding(
      ...
      child: Text(
        "This is no kid’s toy.\nMeasuring over 4” (11cm) high, 20” (52cm) long and 22” (58cm) wide.",
        style: TextStyle(
          color: Colors.grey[600],
        ),
      ),
